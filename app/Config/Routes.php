...
$routes->group('admin', ['filter' => 'adminAuth'], static function ($routes): void {
    ...
    $routes->post('departments/(:num)/status', 'Admin\DepartmentController::toggleStatus/$1');
    $routes->get('designations', 'Admin\DesignationController::index');
    $routes->get('designations/create', 'Admin\DesignationController::create');
    $routes->post('designations', 'Admin\DesignationController::store');
    $routes->get('designations/(:num)/edit', 'Admin\DesignationController::edit/$1');
    $routes->post('designations/(:num)/update', 'Admin\DesignationController::update/$1');
    $routes->post('designations/(:num)/status', 'Admin\DesignationController::toggleStatus/$1');
    ...
    $routes->get('employees/(:num)/edit', 'Admin\EmployeeController::edit/$1');
    $routes->post('employees/(:num)/update', 'Admin\EmployeeController::update/$1');
    $routes->post('employees/(:num)/status', 'Admin\EmployeeController::toggleStatus/$1');
    $routes->get('employee-hierarchy', 'Admin\EmployeeHierarchyController::index');
    $routes->post('employee-hierarchy', 'Admin\EmployeeHierarchyController::store');
