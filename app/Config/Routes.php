...
$routes->group('admin', ['filter' => 'adminAuth'], static function ($routes): void {
    ...
    $routes->post('accounts/tax-masters/tax-types/(:num)/status', 'Admin\TaxMasterController::toggleTaxType/$1', ['filter' => 'permission:accounts.payments']);
    $routes->post('accounts/tax-masters/gst', 'Admin\TaxMasterController::storeGstMaster', ['filter' => 'permission:accounts.payments']);
    $routes->post('accounts/tax-masters/gst/(:num)/status', 'Admin\TaxMasterController::toggleGstMaster/$1', ['filter' => 'permission:accounts.payments']);
