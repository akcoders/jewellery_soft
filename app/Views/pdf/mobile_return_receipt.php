    ...
    <div class="sheet">
        ...
        <div class="section">
            <table class="meta">
                ...
                <tr><td class="label">Address:</td><td><?= esc(trim(implode(', ', array_filter([(string) ($return['karigar_address'] ?? ''), (string) ($return['karigar_city'] ?? ''), (string) ($return['karigar_state'] ?? ''), (string) ($return['karigar_pincode'] ?? '')])) ?: '-') ?></td></tr>
