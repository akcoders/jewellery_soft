...
<div class="row g-3 mb-3">
    <div class="col-md-2"><div class="card h-100"><div class="card-body py-2"><small class="text-muted d-block">Rows</small><h5 class="mb-0"><?= (int) ($summary['row_count'] ?? 0) ?></h5></div></div></div>
    <div class="col-md-2"><div class="card h-100"><div class="card-body py-2"><small class="text-muted d-block">Gold Issued</small><h5 class="mb-0"><?= number_format((float) ($summary['issue_gold_gm'] ?? 0), 3) ?> gm</h5></div></div></div>
    <div class="col-md-2"><div class="card h-100"><div class="card-body py-2"><small class="text-muted d-block">Gold Received</small><h5 class="mb-0"><?= number_format((float) ($summary['receive_gold_gm'] ?? 0), 3) ?> gm</h5></div></div></div>
    <div class="col-md-2"><div class="card h-100"><div class="card-body py-2"><small class="text-muted d-block">Cts Issued</small><h5 class="mb-0"><?= number_format((float) ($summary['issue_cts'] ?? 0), 3) ?></h5></div></div></div>
    <div class="col-md-2"><div class="card h-100"><div class="card-body py-2"><small class="text-muted d-block">Payable</small><h5 class="mb-0">Rs <?= number_format((float) ($summary['payable_amount'] ?? 0), 2) ?></h5></div></div></div>
    <div class="col-md-2"><div class="card h-100"><div class="card-body py-2"><small class="text-muted d-block">Paid</small><h5 class="mb-0">Rs <?= number_format((float) ($summary['paid_amount'] ?? 0), 2) ?></h5></div></div></div>
</div>
