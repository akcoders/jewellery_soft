...
<div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <div class="d-flex gap-2">
        <a href="<?= site_url('admin/gold-inventory/issues/voucher/' . $issue['id']) ?>" target="_blank" class="btn btn-outline-success">
            <i class="fe fe-printer"></i> Print Voucher
        </a>
        <a href="<?= site_url('admin/gold-inventory/issues/' . $issue['id'] . '/edit') ?>" class="btn btn-outline-info">
            <i class="fe fe-edit"></i> Edit
        </a>
        <a href="<?= site_url('admin/gold-inventory/issues') ?>" class="btn btn-outline-primary">Back</a>
    </div>
</div>
...
<div class="card mb-3">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12 mt-2"><strong>Notes:</strong> <?= esc((string) ($issue['notes'] ?: '-')) ?></div>
        </div>
    </div>
</div>
