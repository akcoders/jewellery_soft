...
<div class="d-flex align-items-center justify-content-between mb-3">
    <h4 class="mb-0">Gold Stock Adjustments</h4>
    <a href="<?= site_url('admin/gold-inventory/adjustments/create') ?>" class="btn btn-primary">
    ...
    <div class="card-body">
        <form method="get" class="row g-2 align-items-end">
            ...
            <div class="col-md-6">
                ...
                <a href="<?= site_url('admin/gold-inventory/adjustments') ?>" class="btn btn-light">Reset</a>
            </div>
        </form>
    </div>
</div>
                ...
                <tbody>
                    ...
                    <?php foreach (($adjustments ?? []) as $adj): ?>
                        <tr>
                            ...
                            <td><?= number_format((float) $adj['total_weight'], 3) ?> gm</td>
                            <td><?= number_format((float) $adj['total_value'], 2) ?></td>
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="<?= site_url('admin/gold-inventory/adjustments/view/' . $adj['id']) ?>" class="btn btn-sm btn-outline-primary"><i class="fe fe-eye"></i></a>
                                    <a href="<?= site_url('admin/gold-inventory/adjustments/' . $adj['id'] . '/edit') ?>" class="btn btn-sm btn-outline-info"><i class="fe fe-edit"></i></a>
                                    <form method="post" action="<?= site_url('admin/gold-inventory/adjustments/' . $adj['id'] . '/delete') ?>" onsubmit="return confirm('Delete this adjustment?');">
                                        <?= csrf_field() ?>
