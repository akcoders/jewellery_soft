...
<div class="erp-page-toolbar flex-wrap mb-3">
    <div>
        <span class="erp-eyebrow">Diamond inventory</span>
        <h4 class="mb-1">Diamond Purchases</h4>
        <p class="mb-0">Invoice-level carats, grading, tax and supplier details.</p>
    </div>
    <a href="<?= site_url('admin/diamond-inventory/purchases/create') ?>" class="btn btn-primary">
    ...
    <div class="card-body">
        <form method="get" class="row g-2 align-items-end">
            ...
            <div class="col-md-6">
                ...
                <a href="<?= site_url('admin/diamond-inventory/purchases') ?>" class="btn btn-light">Reset</a>
            </div>
        </form>
    </div>
</div>
                ...
                <tbody>
                    ...
                    <?php foreach (($purchases ?? []) as $purchase): ?>
                        <tr>
                            ...
                            <td><?= number_format((float) ($purchase['invoice_total'] ?? $purchase['total_value']), 2) ?></td>
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="<?= site_url('admin/diamond-inventory/purchases/view/' . $purchase['id']) ?>" class="btn btn-sm btn-outline-primary"><i class="fe fe-eye"></i></a>
                                    <a href="<?= site_url('admin/diamond-inventory/purchases/' . $purchase['id'] . '/edit') ?>" class="btn btn-sm btn-outline-info"><i class="fe fe-edit"></i></a>
                                    <form method="post" action="<?= site_url('admin/diamond-inventory/purchases/' . $purchase['id'] . '/delete') ?>" onsubmit="return confirm('Delete this purchase?');">
                                        <?= csrf_field() ?>
