...
class AppTheme {
  ...
  static ThemeData cookifyTheme = AppTheme.themeType == ThemeType.light ? cookifyLightTheme : cookifyDarkTheme;

  static ThemeData plantTheme = AppTheme.themeType == ThemeType.light ? plantLightTheme : plantDarkTheme;
  ...
  static ThemeData smartShopping = AppTheme.themeType == ThemeType.light ? smartShoppingLightTheme : smartShoppingDarkTheme;

  static ThemeData smartShoppingLightTheme = createTheme(ColorScheme.fromSeed(seedColor: Color(0xff69548d)));
  static ThemeData smartShoppingDarkTheme = createTheme(ColorScheme.fromSeed(seedColor: Color(0xffd4bbfc)));
  ...
  static ThemeData homemadeTheme = AppTheme.themeType == ThemeType.light ? homemadeLightTheme : homemadeDarkTheme;
  ...
  static ThemeData learningTheme = AppTheme.themeType == ThemeType.light ? learningLightTheme : learningDarkTheme;
  ...
  static ThemeData shoppingTheme = AppTheme.themeType == ThemeType.light ? shoppingLightTheme : shoppingDarkTheme;
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    tabBarTheme: TabBarThemeData(
      ...
      indicator: UnderlineTabIndicator(borderSide: BorderSide(color: Color(0xff3d63ff), width: 2.0)),
    ),
    ...
    /// Radio theme
    radioTheme: RadioThemeData(fillColor: WidgetStateProperty.all(Color(0xff3C4EC5))),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    tabBarTheme: TabBarThemeData(
      ...
      indicatorSize: TabBarIndicatorSize.label,
      indicator: UnderlineTabIndicator(borderSide: BorderSide(color: Color(0xff069DEF), width: 2.0)),
    ),
  ...
  static void resetThemeData() {
    ...
    plantTheme = AppTheme.themeType == ThemeType.light ? plantLightTheme : plantDarkTheme;

    smartShopping = AppTheme.themeType == ThemeType.light ? smartShoppingLightTheme : smartShoppingDarkTheme;
